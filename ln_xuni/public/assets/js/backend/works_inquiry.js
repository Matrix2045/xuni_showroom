define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'works_inquiry/index' + location.search,
                    del_url: 'works_inquiry/del',
                    table: 'works_inquiry',
                }
            });
            ...
            table.bootstrapTable({
                ...
                exportTypes:['excel'],
                exportOptions: {
                    fileName: '询价信息_' + Moment().format("YYYY-MM-DD"),
                ...
                columns: [
                    [
                        ...
                        {field: 'username', title: __('询价用户姓名'),operate:'LIKE'},
                        {field: 'mobile', title: __('询价用户手机号')},
