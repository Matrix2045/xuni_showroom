...
(function (root, factory) {
	...
	Loading.prototype = {
		loadingTpl: '<div class="ui-loading"><div class="ui-loading-mask"></div><p class="info"><i></i>正在合成中，请稍后！</p></div>',
		stop: function () {
			this.loading.remove();
			this.loading = null;
		},
		...
		setPosition: function () {
            ...
            loading.height(1268).width(cw);
            loading.find('div').height(1268).width(cw);
            if (ch < 100) {
                loading.find('i').height(ch).width(ch);
            }
