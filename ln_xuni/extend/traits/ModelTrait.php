...
trait ModelTrait
{
    ...
    public static function edit($data,$id,$field = null)
    {
        ...
        return false !== $model->where($field,$id)->update($data);
    }
     ...
     * @return bool $type 返回成功失败
     */
    public static function editAll($data,$map,$field = null)
    {
        $model = new self;
        ...
        return false !== $model->where($map)->update($data);
    }
     ...
     * @return bool $type 返回成功失败
     */
    public static function delStatus($map,$field = null)
    {
        $model = new self;
        if(!is_array($map) && empty($field)){
            $field = $model->getPk();
        ...
        return false !== $model->where($map)->update(['status'=>0]);
    }
     ...
     * @return bool
     */
    public static function bcInc($key, $incField, $inc=1, $keyField = null, $acc=2)
    {
